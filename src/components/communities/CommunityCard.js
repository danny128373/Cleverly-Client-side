...
export default function CommunityCard(props) {
    ...
    const handleDelete = () => {
        ApiManager.delete(props.community.community.id, 'communities')
    ...
    const uploadImage = async event => {
        ...
        ApiManager.update({ ...props.community.community, image: file.url }, 'communities').then(e => {
    ...
    return (
        ...
        <div className="communityImageContainer">
            <img className='communityImage' alt='community' src={props.community.community.image}/>
        </div>
